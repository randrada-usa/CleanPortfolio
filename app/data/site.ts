...
export const projects: Project[] = [
  {
    ...
    summary:
      "A touchless gesture-controlled gacha game built for the Capiztahan festival—wave your hand to catch local icons and win real prizes.",
  ...
  },
  {
    ...
    summary:
      "A community-driven marketplace connecting local farmers with consumers through secure ordering, subscriptions, and AI-assisted verification.",
    image: projectAsset("IFC.webp"),
  ...
  },
  {
    ...
    summary:
      "A bilingual barangay services platform with AI-assisted public support, automated workflows, and secure administrative records.",
    image: projectAsset("e-serbisyo1.webp"),
...
export const certifications: Certification[] = [
  cert("Data Analyst Associate", "DataCamp", "Data & Analytics", "DataCamp Data Analyst Associate Certification.webp", "Associate-level validation of practical data analysis skills."),
  cert("SQL Associate", "DataCamp", "Data & Analytics", "DataCamp SQL Associate Certification.webp", "Associate-level validation of SQL querying and data analysis."),
  cert("Introduction to Data Engineering", "DataCamp", "Data & Analytics", "DataCamp Intro to Data Engineering Course.webp", "Foundations of data engineering systems, workflows, and responsibilities."),
  cert("Understanding Data Engineering", "DataCamp", "Data & Analytics", "DataCamp Understanding Data Engineering Course.webp", "Core concepts behind reliable data platforms and pipelines."),
  ...
  cert("AI Fundamentals", "DataCamp", "Artificial Intelligence", "DataCamp AI Fundamentals.webp", "Credential covering essential artificial-intelligence concepts and applications."),
  cert("AI Fundamentals Course", "DataCamp", "Artificial Intelligence", "DataCamp AI Fundamentals Course.webp", "Coursework in machine learning, generative AI, and responsible use."),
  cert("AI Ethics", "DataCamp", "Artificial Intelligence", "DataCamp AI Ethics Course.webp", "Responsible AI principles, risks, fairness, and governance."),
